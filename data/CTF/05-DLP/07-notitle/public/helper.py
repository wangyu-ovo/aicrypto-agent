lines = open(r"public/output.txt", "r").readlines()
...
magic_pi = eval(lines[0].split("= ")[1])
magic_e = eval(lines[1].split("= ")[1])
obfuscated_keys = eval(lines[2].split("= ")[1])
ct = eval(lines[3].split("= ")[1])
iv = eval(lines[4].split("= ")[1])
