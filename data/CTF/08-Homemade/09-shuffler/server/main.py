...
if __name__ == "__main__":
    flag = b'uoftctf{Intr0ductioN_2_dyNam1cal_sYst3m_&_cha05}' #hide
    initial_x = Fraction('21531381735306/140737488355327') #hide
    initial_y = Fraction('90126572366280/140737488355327') #hide
    k = 47 #hide
